...
class Exp_Main(Exp_Basic):
    ...
    def _select_optimizer(self):
        model_optim = optim.Adam(self.model.parameters(), lr=0.01)
        return model_optim
    ...
    def train(self, setting, gradiv = False, loss_adap=False, mmd_loss = False):
        ...
        for epoch in range(10):
            ...
            adjust_learning_rate(model_optim, epoch + 1, self.args, printout=True)
    ...
    def test(self, setting):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                ...
                # encoder - decoder
                outputs = self.best_model(batch_x, batch_x_mark, dec_inp, batch_y_mark)
